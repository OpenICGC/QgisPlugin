...
services_list = [
    # (id, name, min_side, max_query_area, download_type_list, default_filename, url_pattern, <(url_ref, qml_style) | (wms_url, wms_layer, wms_style, wms_format)>),
    ...
    ("topografia-territorial", "Referencial topogràfic territorial", 50, 50000000, ["", "mu"], "topografia-territorial.tif", "%s/fmedatastreaming/Descarrega_basica/geotiff2format_clip_coor.fmw?SW_X=%s&SW_Y=%s&NE_X=%s&NE_Y=%s&DEF_NAME=bt5m&Format=GEOTIFF&Projecte=topografia-territorial&Codi=%s", None),
    ...
    ("divisions-administratives", "Divisions administratives", None, None, ["cat", "tot"], "divisions-administratives.zip", "%s/fmedatastreaming/Descarrega_basica/descarrega_shape_coor.fmw?SW_X=%s&SW_Y=%s&NE_X=%s&NE_Y=%s&Projecte=divisions-administratives&Codi=%s", None),

    ("topografia-territorial-gpkg", "Referencial topogràfic territorial GeoPackage", None, 100000000, ["", "mu"], "topografia-territorial.gpkg", "%s/fmedatastreaming/topografia-territorial/ICGC_topografia-territorial_gpkg_clip.fmw?xMin=%s&yMin=%s&xMax=%s&yMax=%s&Codi=%s", None),
    ("topografia-territorial-dgn", "Referencial topogràfic territorial DGN", 5, 50000000, ["", "mu", "co"], "topografia-territorial.dgn", "%s/fmedatastreaming/topografia-territorial/ICGC_topografia-territorial_clip_to_CAD.fmw?xMin=%s&yMin=%s&xMax=%s&yMax=%s&format_cad=DGN&file_name=tt&Codi=%s", None),
    #("topografia-territorial-dwg", "Referencial topogràfic territorial DGW", 5, 50000000, ["", "mu"], "topografia-territorial.dwg", "%s/fmedatastreaming/topografia-territorial/ICGC_topografia-territorial_clip_to_CAD.fmw?xMin=%s&yMin=%s&xMax=%s&yMax=%s&format_cad=DWG&file_name=tt&Codi=%s", None),
    #("topografia-territorial-3d-dwg", "Referencial topogràfic territorial 3D DGW", 5, 50000000, ["", "mu"], "topografia-territorial-3d.dwg", "%s/fmedatastreaming/topografia-territorial/ICGC_topografia-territorial_clip_to_CAD3D.fmw?xMin=%s&yMin=%s&xMax=%s&yMax=%s&file_name=tt3d&Codi=%s", None),

    ("cobertes-sol-raster", "Mapa de cobertes del sòl", 100, 200000000, ["", "mu", "co", "cat", "tot"], "cobertes-sol.tif", "%s/fmedatastreaming/Descarrega_basica/geotiff2format_clip_coor.fmw?SW_X=%s&SW_Y=%s&NE_X=%s&NE_Y=%s&DEF_NAME=mcsc&Format=GEOTIFF&Projecte=cobertes-sol&Codi=%s", None),
    ("cobertes-sol-vector", "Mapa de cobertes del sòl", None, 400000000, ["", "mu", "co"], "cobertes-sol.gpkg", "%s/fmedatastreaming/cobertes-sol/ICGC_cobertes-sol_gpkg_clip.fmw?xMin=%s&yMin=%s&xMax=%s&yMax=%s&Codi=%s", None),
    ...
    #("gt1", "GT I. ... 1:25.000", None, 1250000000, ["", "mu", "co"], "gt1.zip", "%s/fmedatastreaming/Descarrega_basica/descarrega_shape_coor.fmw?SW_X=%s&SW_Y=%s&NE_X=%s&NE_Y=%s&Projecte=gt1&Codi=%s",
    #    ("https://geoserveis.icgc.cat/icgc_geotreballs/wms/service", "geotreball_I", "", "image/png")),
    #("gt2", "GT II. ...  1:25.000", None, 1250000000, ["", "mu", "co", "cat", "tot"], "gt2.zip", "%s/fmedatastreaming/Descarrega_basica/descarrega_shape_coor.fmw?SW_X=%s&SW_Y=%s&NE_X=%s&NE_Y=%s&Projecte=gt2&Codi=%s",
    #    ("https://geoserveis.icgc.cat/icgc_geotreballs/wms/service", "geotreball_II", "", "image/png")),
    #("gt3", "GT III. ... 1:5.000", None, 50000000, ["", "mu", "co", "cat", "tot"], "gt3.zip", "%s/fmedatastreaming/Descarrega_basica/descarrega_shape_coor.fmw?SW_X=%s&SW_Y=%s&NE_X=%s&NE_Y=%s&Projecte=gt3&Codi=%s",
    #    ("https://geoserveis.icgc.cat/icgc_geotreballs/wms/service", "geotreball_III", "", "image/png")),
    #("gt4", "GT IV. ... 1:25.000", None, 1250000000, ["", "mu", "co", "cat", "tot"], "gt4.zip", "%s/fmedatastreaming/Descarrega_basica/descarrega_shape_coor.fmw?SW_X=%s&SW_Y=%s&NE_X=%s&NE_Y=%s&Projecte=gt4&Codi=%s",
    #    ("https://geoserveis.icgc.cat/icgc_geotreballs/wms/service", "geotreball_IV", "", "image/png")),
    #("gt5", "GT V. ... 1:25.000", None, 1250000000, ["", "mu", "co", "cat", "tot"], "gt5.zip", "%s/fmedatastreaming/Descarrega_basica/descarrega_shape_coor.fmw?SW_X=%s&SW_Y=%s&NE_X=%s&NE_Y=%s&Projecte=gt5&Codi=%s",
