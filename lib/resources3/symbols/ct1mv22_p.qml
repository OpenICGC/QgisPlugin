...
<qgis minScale="1e+08" simplifyAlgorithm="0" version="3.4.6-Madeira" labelsEnabled="0" simplifyDrawingTol="1" simplifyLocal="1" simplifyMaxScale="1" maxScale="0" hasScaleBasedVisibilityFlag="0" readOnly="0" styleCategories="AllStyleCategories" simplifyDrawingHints="1">
  ...
  <renderer-v2 symbollevels="0" enableorderby="0" forceraster="0" type="RuleRenderer">
    <rules key="{d2607964-9124-4d98-aa3b-a3a717473e73}">
      <rule key="{f54195b2-244f-4f22-953a-2b2abfa09d39}" symbol="0" filter=" &quot;CAS&quot;  like 'CON_13%' " label="Illa urbana"/>
      <rule key="{37552bb2-e0a4-4468-81d0-5cffc6661437}" symbol="1" filter=" &quot;CAS&quot;  like 'CON_11%' " label="Polígon d'hivernacle"/>
      <rule key="{bcdc4af2-04bc-402c-90a9-0991ce6ca166}" symbol="2" filter=" &quot;CAS&quot;  like 'CON_09%' " label="Marquesina"/>
      <rule key="{3df8b6a7-b1ac-4092-a5db-573950c35bae}" symbol="3" filter=" &quot;CAS&quot;  like 'CON_08%' " label="Porxo"/>
      <rule key="{27a3e5d4-0fd4-4a4e-bed9-69deb2bc48e2}" symbol="4" filter=" &quot;CAS&quot;  like 'CON_07%' " label="Cobert"/>
      <rule key="{79dcec05-6a0d-47d0-8398-912ea6062025}" symbol="5" filter=" &quot;CAS&quot;  like 'CON_18%' " label="Construcció"/>
      <rule key="{27a3e5d4-0fd4-4a4e-bed9-69deb2bc48e2}" symbol="6" filter=" &quot;CAS&quot;  like 'CON_22%' " label="Monuments"/>
      <rule key="{8a9b9dc2-ad27-42c6-bbe5-22d261bb4ba1}" symbol="7" filter=" &quot;CAS&quot;  like 'CON_21%' " label="Dipòsit cobert"/>
      <rule key="{051d3b0f-e19c-498f-9bf8-0abff82bd6aa}" symbol="8" filter=" &quot;CAS&quot;  like 'CON_01%' or  &quot;CAS&quot;  like 'CON_06%' or  &quot;CAS&quot;  like 'CON_10%'" label="Polígon d'edifici"/>
      <rule key="{762bc1f1-9982-4d89-b984-0699c9fe2ec9}" symbol="9" filter=" &quot;CAS&quot;  like 'CON_12%'" label="Escullera"/>
      <rule key="{86eb4d44-d83a-4293-a375-16243b8bef84}" symbol="10" filter=" &quot;CAS&quot;  like 'VEG_08%'" label="Platja, sorral"/>
      <rule key="{fa22c0aa-befd-442e-865d-233f2dd7ed61}" symbol="11" filter="&quot;CAS&quot; like 'ENE_02%'" label="Torre"/>
      <rule key="{f9c0dbba-59fc-497e-9b24-802d60fd529d}" symbol="12" checkstate="0" filter="ELSE"/>
    </rules>
    <symbols>
      ...
      <symbol name="1" alpha="1" force_rhr="0" clip_to_extent="1" type="fill">
        <layer pass="0" class="SimpleFill" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="203,253,199,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol name="10" alpha="1" force_rhr="0" clip_to_extent="1" type="fill">
        <layer pass="0" class="PointPatternFill" enabled="1" locked="0">
          ...
          <symbol name="@10@0" alpha="1" force_rhr="0" clip_to_extent="1" type="marker">
      ...
      <symbol name="11" alpha="1" force_rhr="0" clip_to_extent="1" type="fill">
        <layer pass="0" class="LinePatternFill" enabled="1" locked="0">
          ...
          <symbol name="@11@0" alpha="1" force_rhr="0" clip_to_extent="1" type="line">
        ...
        <layer pass="0" class="LinePatternFill" enabled="1" locked="0">
          ...
          <symbol name="@11@1" alpha="1" force_rhr="0" clip_to_extent="1" type="line">
            <layer pass="0" class="SimpleLine" enabled="1" locked="0">
              <prop k="capstyle" v="square"/>
              <prop k="customdash" v="5;2"/>
              <prop k="customdash_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="12" alpha="1" force_rhr="0" clip_to_extent="1" type="fill">
        <layer pass="0" class="SimpleFill" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
      ...
      <symbol name="7" alpha="1" force_rhr="0" clip_to_extent="1" type="fill">
        <layer pass="0" class="SimpleFill" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="220,220,220,255"/>
          <prop k="joinstyle" v="bevel"/>
      ...
      <symbol name="8" alpha="1" force_rhr="0" clip_to_extent="1" type="fill">
        <layer pass="0" class="SimpleFill" enabled="1" locked="0">
          <prop k="border_width_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="color" v="252,216,216,255"/>
          <prop k="joinstyle" v="bevel"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="offset_unit" v="MM"/>
      ...
      <symbol name="9" alpha="1" force_rhr="0" clip_to_extent="1" type="fill">
        <layer pass="0" class="PointPatternFill" enabled="1" locked="0">
          <prop k="displacement_x" v="0"/>
          <prop k="displacement_x_map_unit_scale" v="3x:0,0,0,0,0,0"/>
          <prop k="displacement_x_unit" v="MM"/>
          ...
          <symbol name="@9@0" alpha="1" force_rhr="0" clip_to_extent="1" type="marker">
            <layer pass="0" class="SimpleMarker" enabled="1" locked="0">
              <prop k="angle" v="0"/>
              <prop k="color" v="35,35,35,255"/>
              <prop k="horizontal_anchor_point" v="1"/>
  ...
  <DiagramLayerSettings linePlacementFlags="18" zIndex="0" showAll="1" obstacle="0" dist="0" priority="0" placement="1">
    <properties>
      <Option type="Map">
        <Option name="name" value="" type="QString"/>
        <Option name="properties"/>
