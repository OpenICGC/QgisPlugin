...
<qgis labelsEnabled="1" readOnly="0" styleCategories="LayerConfiguration|Symbology|Labeling|MapTips" version="3.10.6-A Coruña">
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style fontKerning="1" fontCapitals="0" fontWeight="75" fontFamily="Tahoma" previewBkgrdColor="255,255,255,255" fontWordSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" namedStyle="Bold" fontSize="14" textOrientation="horizontal" useSubstitutions="0" textColor="0,0,0,255" fieldName="NOMPROV" fontLetterSpacing="0" blendMode="0" fontSizeUnit="Point" isExpression="0" fontUnderline="0" fontStrikeout="0" multilineHeight="1" fontItalic="0" textOpacity="1">
  ...
  <previewExpression>NOMPROV</previewExpression>
  <mapTip></mapTip>
