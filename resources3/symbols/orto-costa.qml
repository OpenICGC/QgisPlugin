...
<qgis minScale="1e+08" hasScaleBasedVisibilityFlag="0" maxScale="0" version="3.28.1-Firenze" styleCategories="AllStyleCategories">
  <flags>
  ...
  <elevation enabled="0" band="1" zscale="1" zoffset="0" symbology="Line">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="0.5" nodataColor="" alphaBand="-1" band="1" type="singlebandcolordata">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
    ...
    <huesaturation colorizeStrength="100" saturation="-100" colorizeOn="1" colorizeGreen="255" colorizeBlue="255" grayscaleMode="0" invertColors="0" colorizeRed="35"/>
